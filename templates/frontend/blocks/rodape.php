    ...
    <div class="container">
        <div class="pgto-social row text-center">
            <div class="col-auto me-auto">
                <strong><i class="fa-regular fa-credit-card"></i> Pagamentos</strong>
                <div class="mt-2 pt-2 border-top border-dark">
                    <i class="fa-brands fs-3 pe-1 fa-cc-visa"></i>
                    <i class="fa-brands fs-3 pe-1 fa-cc-mastercard"></i>
                    <i class="fa-brands fs-3 pe-1 fa-cc-paypal"></i>
                    <i class="fa-brands fs-3 pe-1 fa-cc-amex"></i>
                    <i class="fa-brands fs-3 pe-1 fa-pix"></i>
                </div>
            </div>
            <div class="col-auto">
        ...
        <div class="info-matriz row mt-5 text-center">
            <div>Preços e condições exclusivos para o <?= $site??''?> (exceto alimentos e bebidas), podendo sofrer alterações sem prévia notificação.
            </div>
                <div><?= $nomefantasia??''?> | 
                <?= $site??'' ?> | 
